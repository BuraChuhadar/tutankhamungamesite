...
export function Footer() {
  return (
    <footer 
      ...
      className="footer-blended relative w-full"
    >
      <div className="container mx-auto px-5">
        <div className="py-16 flex flex-col lg:flex-row items-center">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center lg:pl-4 lg:w-1/2">
            <div className="mx-3 bg-gray-600 dark:bg-[#40362b] border border-gray-600 dark:border-[#40362b] text-gray-200 dark:text-[#f5e9d6] font-bold py-3 px-12 lg:px-8 mb-6 lg:mb-0 opacity-70 cursor-not-allowed" suppressHydrationWarning>
